...
EXPERIMENTS = [
    ...
    "experiments/exp030_risk_sensitivity.py",
    "experiments/exp031_acquisition_tuning.py",
    "experiments/exp032_mechanistic_energy_budget.py",
    "experiments/exp033_multilevel_reinforcement.py",
    "experiments/exp034_bridge_generalization.py",
    "experiments/exp035_upper_boundary.py",
    "experiments/exp036_atom_survival_choice.py",
    "experiments/exp037_spatial_survival_choice.py",
    "experiments/exp038_graded_teaching.py",
    "experiments/exp039_blocking_overshadowing.py",
    "experiments/exp040_behavioral_contrast.py",
    "experiments/exp041_anticipatory_contrast.py",
    "experiments/exp042_zoo_robustness.py",
    "experiments/exp043_core_robustness.py",
    "experiments/exp044_generalization_peak_shift_jax.py",
    "experiments/exp045_spatial_survival_2d.py",
    "experiments/exp046_travel_cost_study.py",
    "experiments/exp047_vr_vi_feedback.py",
    "experiments/exp048_integrator_ablation.py",
    "experiments/exp049_rl_baseline_matching.py",
    "experiments/exp050_predation_panel.py",
    "experiments/exp051_charnov_reduction.py",
    "experiments/exp052_rl_baseline_acquisition.py",
    "experiments/exp053_autodiff_diagnostic.py",
    "experiments/exp054_temperance.py",
    "experiments/exp055_sequence_identifiability.py",
    "experiments/exp056_learning_rate_degeneracy.py",
    "experiments/exp057_bet_hedging.py",
    "experiments/exp058_model_comparison.py",
    "experiments/exp059_molecular_bridge.py",
    "experiments/exp060_integrator_audit.py",
    "experiments/exp061_multidim_atoms.py",
    "experiments/exp062_cpg_in_organism.py",
    "scripts/run_demo.py",
